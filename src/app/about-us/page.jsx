            ...
            <div className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                        ...
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">At <span className="text-red-500">ThaKhinGyiMyar</span> Team, our team of dedicated developers is at the heart of our success. With a passion for innovation and a commitment to excellence, they bring your digital dreams to life.</p>
                    </div>
